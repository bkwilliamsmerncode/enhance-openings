        ...
        <div className="xlsinner">
          <div className="page1Main">
              ...
              <div className="hero2">
                <div className="heroleft">
                  <div className="herotext1">
                    <h2>Illuminate Your Home With Velux</h2>
                  </div>
                  <br />
                  <div className="herotext2">
                    <p>Get a 30% Federal Tax Rebate on</p>
                  </div>
                  <div className="herotext2">
                    <p>Skylights & Sun Tunnels</p>
                  </div>
                </div>
            ...
            <div className="middleThree">
              <button className="three">Promotions & Specials</button>
              <button className="three">Built for Arizona</button>
              <button className="three">Guaranteed Expert Installation</button>
            </div>
          </div>
        </div>
      </div>
